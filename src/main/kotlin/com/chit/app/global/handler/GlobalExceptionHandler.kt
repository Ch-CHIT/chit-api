...
class GlobalExceptionHandler {
    ...
    fun handleRuntimeException(ex: RuntimeException): ResponseEntity<ErrorResponse> {
        ...
        return ErrorResponse.Companion.internalErrorWithMessage(ex.message ?: "Internal Server Error")
    }
    ...
    fun handleValidationExceptions(ex: MethodArgumentNotValidException): ResponseEntity<ErrorResponse> {
        ...
        return ErrorResponse.Companion.failWithErrors(HttpStatus.BAD_REQUEST, errors)
    }
    ...
    fun handleIllegalStateException(ex: IllegalStateException): ResponseEntity<ErrorResponse> {
        ...
        return ErrorResponse.Companion.failWithMessage(HttpStatus.BAD_REQUEST, ex.message ?: "Bad Request")
    }
    ...
    fun handleJwtException(ex: JwtException): ResponseEntity<ErrorResponse> {
        ...
        return ErrorResponse.Companion.failWithMessage(HttpStatus.UNAUTHORIZED, ex.message ?: "Unauthorized")
    }
